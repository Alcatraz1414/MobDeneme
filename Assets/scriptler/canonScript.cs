...
public class canonScript : MonoBehaviour
{
  ...
  //  public float moveSpeed = 10f;
    ...
    void Update()
    {
        ...
        {
            lookAround = false;
            transform.position = Vector3.MoveTowards(transform.position, GameObject.Find("Kale1Pozisyon").transform.position , 10*Time.deltaTime);
            if(transform.position== GameObject.Find("Kale1Pozisyon").transform.position)
            {
